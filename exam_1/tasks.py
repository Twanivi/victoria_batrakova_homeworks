...
# import random
# x = [random.randint(19, 21) for i in range(10)]
# print(x)
# # for i in x:
# #     if i == 20:
# #         x.remove(i)
...
# max_len_element = max(text, key=len)
# max_count_element = max(text, key=text.count)
...
# #      “АТТGС" --> "ТААСG"
# #      “GТАТ" --> "САТА"
# dna = input('Введите генетический код: ').upper()
# dna_list = list(dna)
# reverse_dna = []
